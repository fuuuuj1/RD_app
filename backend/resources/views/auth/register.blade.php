                ...
                <div class="form-row form-group">
                    ...
                    <div class="col-lg-2">
                        <div class="custom-control custom-radio" style="padding-top: 7px;padding-bottom: 7px;">
                            ...
                            <label class="custom-control-label" for="gender-men" style="padding-top: 1px;">男</label>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="custom-control custom-radio" style="padding-top: 7px;padding-bottom: 7px;">
                            <input type="radio" id="gender-female" class="custom-control-input" name="gender" value="female">
                            <label class="custom-control-label" for="gender-female" style="padding-top: 1px;">女</label>
                        </div>
                    </div>
                </div>
                <div class="form-row form-group">
